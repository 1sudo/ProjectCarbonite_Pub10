...
object_tangible_wearables_shirt_shirt_invis = object_tangible_wearables_shirt_shared_shirt_invis:new {
	playerRaces = { 	
...
ObjectTemplates:addTemplate(object_tangible_wearables_shirt_shirt_invis, "object/tangible/wearables/shirt/shirt_invis.iff")