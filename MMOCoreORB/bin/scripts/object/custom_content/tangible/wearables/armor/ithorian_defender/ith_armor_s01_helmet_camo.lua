...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_ithorian_defender_ith_armor_s01_helmet_camo, "object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_helmet_camo.iff")
